...
# Custom pic for the maintainer's info in about section
	export OF_MAINTAINER_AVATAR="$PWD/device/oplus/PEQM00/maintainer.png"
	
# Device Information.
	export FOX_ARCH=arm64
	export FOX_VARIANT="A12_FBEv1"
	export TARGET_DEVICE_ALT="PEQM00,OP4ED5,OP4E2F,op6877" # I am not what are the over possible names.
